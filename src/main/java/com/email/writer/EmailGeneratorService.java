...
public class EmailGeneratorService {
    ...
    private String builtPrompt(EmailRequest emailRequest) {
        ...
        prompt.append("Generate a professional email reply for the following email content and include code snippets if requested. Please don't generate a subject line");
